 ...
 */
export function printStudentCard({ studentName, studentNumber, gradeName, groupName, qrDataUrl, schoolName, teacherName }) {
...
<style>
  * { box-sizing: border-box; }
  ...
  .card-teacher { font-size: 10px; color: #111827; font-weight: 700; margin-bottom: 2px; }
  ...
  .card-qr { width: 28mm; flex-shrink: 0; display: flex; flex-direction: column; align-items: center; gap: 2px; }
  .card-qr img { width: 26mm; height: 26mm; object-fit: contain; }
  .card-qr-hint { font-size: 6.5px; color: #6b7280; text-align: center; line-height: 1.25; }
  @media print {
...
<body>
  ...
  <div class="card">
    <div class="card-info">
      ${teacherName ? `<div class="card-teacher">أ / ${teacherName}</div>` : ''}
    ...
    <div class="card-qr">
      ...
      <div class="card-qr-hint">امسح بكاميرا موبايلك لمتابعة الطالب</div>
    </div>
  </div>
  <script>
